Temporal Modeling with TCN: Built and trained a Temporal Convolutional Network (TCN) to learn long-range patterns from server logs for predicting potential hardware failures.
